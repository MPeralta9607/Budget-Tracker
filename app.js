...
(function(){
            ...
            if(type === 'income'){
              ...
              if(!skipped.has(key) && !existingExpense.has(key)){
                data.expenses.push({
                  ...
                  paymentMethod: type === 'expense' ? (rule.paymentMethod || 'other') : undefined,
                  date: iso,
                  recurringId: rule.id,
                  recurringDate: iso,
                  recurringLabel: label
  ...
  function renderRecurringList(){
    ...
    listEl.innerHTML = active
      ...
      .map(rule => {
        ...
        if(rule.type === 'expense' && rule.paymentMethod){
  ...
  function setEntryMode(mode){
    ...
    $('paymentMethodField').style.display = mode==='expense' ? 'block' : 'none';
    ...
    if(editingEntry){
      ...
      if(updatingRecurringRule){
        ...
        if(rule){
          ...
          if(editingEntry.type === 'expense') rule.paymentMethod = resolvePaymentMethod();
