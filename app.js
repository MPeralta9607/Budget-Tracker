...
(function(){
  ...
  let uiState = { expensesCollapsed:false, recurringCollapsed:false };
  ...
  function loadUiState(){
    try{
      ...
      uiState = { expensesCollapsed:false, recurringCollapsed:false };
    }
  }
  ...
  $('toggleRecurring').addEventListener('click', () => {
    uiState.recurringCollapsed = !uiState.recurringCollapsed;
    saveUiState();
    renderRecurringList();
  });
